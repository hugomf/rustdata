...
impl BindAdapter<sqlx::MySql> for MysqlBindAdapter {
    ...
    fn bind_uuid<'q>(q: QueryBuilder<'q, sqlx::MySql>, v: Uuid) -> QueryBuilder<'q, sqlx::MySql> {
        q.bind(v.to_string())
    }
    fn bind_opt_uuid<'q>(
        q: QueryBuilder<'q, sqlx::MySql>,
        v: Option<Uuid>,
    ) -> QueryBuilder<'q, sqlx::MySql> {
        q.bind(v.map(|v| v.to_string()))
    }
    fn bind_str<'q>(q: QueryBuilder<'q, sqlx::MySql>, v: &'q str) -> QueryBuilder<'q, sqlx::MySql> {
        q.bind(v)
    }
    fn bind_opt_str<'q>(
        q: QueryBuilder<'q, sqlx::MySql>,
    ...
    fn bind_int<'q>(q: QueryBuilder<'q, sqlx::MySql>, v: i64) -> QueryBuilder<'q, sqlx::MySql> {
        q.bind(v)
    }
    fn bind_opt_int<'q>(
        q: QueryBuilder<'q, sqlx::MySql>,
    ...
    fn bind_bool<'q>(q: QueryBuilder<'q, sqlx::MySql>, v: bool) -> QueryBuilder<'q, sqlx::MySql> {
        q.bind(v)
    }
    fn bind_opt_bool<'q>(
        q: QueryBuilder<'q, sqlx::MySql>,
    ...
    fn bind_float<'q>(q: QueryBuilder<'q, sqlx::MySql>, v: f64) -> QueryBuilder<'q, sqlx::MySql> {
        q.bind(v)
    }
    fn bind_opt_float<'q>(
        q: QueryBuilder<'q, sqlx::MySql>,
...
impl RowExtractor for MysqlExtractor {
    ...
    fn get_uuid(&self, row: &Self::Row, col: &str) -> Result<Uuid, RepositoryError> {
        let s: String = row.try_get(col).map_err(|e| RepositoryError::Extraction {
            column: col.into(),
            reason: e.to_string(),
        })?;
        Uuid::parse_str(&s).map_err(|e| RepositoryError::Extraction {
            column: col.into(),
            reason: e.to_string(),
        })
    }
    fn get_opt_uuid(&self, row: &Self::Row, col: &str) -> Result<Option<Uuid>, RepositoryError> {
        let s: Option<String> = row.try_get(col).map_err(|e| RepositoryError::Extraction {
            column: col.into(),
            reason: e.to_string(),
        })?;
        s.map(|s| {
    ...
    fn get_bool(&self, row: &Self::Row, col: &str) -> Result<bool, RepositoryError> {
        let n: i64 = row.try_get(col).map_err(|e| RepositoryError::Extraction {
            column: col.into(),
            reason: e.to_string(),
        })?;
        Ok(n != 0)
    ...
    fn get_json_value(
        ...
        serde_json::from_str(&s).map_err(|e| RepositoryError::Extraction {
            column: col.into(),
            reason: e.to_string(),
        })
    }
